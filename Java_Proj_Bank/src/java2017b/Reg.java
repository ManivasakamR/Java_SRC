...
public class Reg extends javax.swing.JFrame {
    ...
    public Reg() {
        initComponents();
        jPanel2.setBackground(new Color(170, 0, 255, 150));
        SimpleDateFormat df=new SimpleDateFormat("dd-MMM-yyyy");
        Date td=new Date();
        jLabel13.setText(df.format(td));
    }
    ...
    private void initComponents() {
        ...
        jLabel13.setForeground(new java.awt.Color(240, 163, 10));
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(170, 10, 380, 340);
        ...
        jLabel2.setText("   ");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 10, 150, 160);

        jLabel12.setFont(new java.awt.Font("Trebuchet MS", 0, 24)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(240, 163, 10));
        jLabel12.setText("Welcome");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(60, 170, 98, 29);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Src/BG-REG-01.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            //JOptionPane.showMessageDialog(null, "Test pass");
            try{
                ...
                JOptionPane.showMessageDialog(null, "Account created with Initial AMT RS.1000");                
            }
            catch(Exception e)
            {
