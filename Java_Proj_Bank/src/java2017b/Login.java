...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        jPanel2.setBackground(new Color(170, 0, 255, 40));
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Login - Banking System");
        ...
        jButton1.setBackground(new java.awt.Color(170, 0, 255));
        ...
        jButton2.setBackground(new java.awt.Color(0, 80, 239));
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(0, 30, 530, 230);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Src/BG_LOG.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
{
        int un=Integer.parseInt(jTextField1.getText());
        String pwd1=jPasswordField1.getText();
        if(un!=0){
        Class.forName("oracle.jdbc.OracleDriver");
        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","admin");                             
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select * from bankmaster where acn='"+un+"' and pwd='"+pwd1+"' ");
        if(rs.next())
        {
        if(rs.getInt("acn")==un&&rs.getString("pwd").equals(pwd1)){                       
        Trans t=new Trans();        
        t.setDt(rs.getString("acn"),rs.getString("nam"), rs.getString("csh"));
        t.setVisible(true);
        }
        }
        else
